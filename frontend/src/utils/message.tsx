...
export async function setMemberRole(
    ...
    try {
        console.log('调用 setMemberRole API:', { convId, userId, role });
        ...
        const data = await response.json();
        console.log('setMemberRole API 响应:', data);
        check_for_error(data);
        return true;
    } catch (err) {
        console.log("设置成员角色出错: ", err);
        return false;
    }
}
